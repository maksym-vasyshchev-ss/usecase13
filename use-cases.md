...
UC-12 | Accountant changes tax rules onfiguration | After login, Accountant enters the tax rules configuration page and can edit the rules. The rules take into account the basic information enterd by user and answers to the additional questions.